...
const generateContent = async (req, res) => {
  try {
    ...
    const finalPrompt = `Trước tiên phân tích và làm sạch dữ liệu sau đó chuyển đổi đoạn văn bản sau thành JSON giúp tôi:"${userPrompt}".Đảm bảo rằng đoạn văn bản trả về cho 
